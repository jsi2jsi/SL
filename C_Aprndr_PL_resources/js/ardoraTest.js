...
score=score-scoreDec;}else{successes++;score=score+scoreInc;}}if (successes<minSuccesses){correct=false}if (correct) {timeAct = timeAct + timeBon;$("#ardoraActCanvas").attr("aria-label",messageOk); showMessage("Ok");} else {
