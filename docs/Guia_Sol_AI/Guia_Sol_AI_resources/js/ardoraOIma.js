...
if (fileI.localeCompare(oimaWords(words[i]))!=0){correct=false;}else{successes++;}i++;});if (correct) {score=score+scoreInc;timeAct=timeAct+timeBon;$("#ardoraActCanvas").attr("aria-label",messageOk); showMessage("Ok");} else {
