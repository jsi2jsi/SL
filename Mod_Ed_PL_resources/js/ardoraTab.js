...
if (typeMessage == "Next") {indexTXT++; var textMessage = messageNext;var urlMessage = "";var goURLTarget = "";var borderColor = borderOk;}
...
if (typeMessage == "Next"){backAct(timeOnMessage, oldTypeGame,"1");}
...
function backAct(seg,oldTypeGame,type){setTimeout(function(){if (type=="1"){paintBack();}isShowMessage=false;
...
if ($(".txtCell_txt").length !=0) {var color2="#FF8000";var color1="#FFFDFD";
